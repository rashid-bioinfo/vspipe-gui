...
class VSPipeInterface:
    def __init__(self, master):
        ...
        self.f1_title = Label(self.f1, text="VSpipe - Virtual Screening Toolkit", font="Roman 15 bold", fg="#660099")
        ...
        self.f2_outDir = Label(self.f2, text="Project Directory: ", font="Roman 10 bold")
        self.f2_recep = Label(self.f2, text="Receptor File: ", font="Roman 10 bold")
        self.f2_compLib = Label(self.f2, text="Library Directory: ", font="Roman 10 bold")
        self.f2_outDir.grid(row=1, sticky=W,  pady=5, ipadx=5, ipady=3)
        self.f2_recep.grid(row=2, sticky=W, pady=5, ipadx=19, ipady=2)
        self.f2_compLib.grid(row=3, sticky=W, pady=5, ipadx=3, ipady=3)
        ...
        self.outDir_button.grid(row=1, column=3, padx=5, pady=5)
        ...
        self.f3_xDim.grid(row=1, column=1, padx=3, pady=5)
        ...
        self.load_button = Button(self.f3, text="Load Parameters", bg="#90EE90", font="Roman 10", command=self.load_parameters)
        self.save_button = Button(self.f3, text="Save Parameters", font="Roman 10", command=self.save_parameters)
        ...
        self.docking_type = Label(self.f4, text="Docking Type: ", font="Roman 10 bold")
        self.docking_type.grid(row=1, sticky=W, pady=5, ipadx=9)
        self.docking_method = Label(self.f4, text="Docking Method: ", font="Roman 10 bold")
        self.docking_method.grid(row=2, sticky=W, pady=5)
        ### -----   Define type and method of docking (Radio Buttons - blind/targeted) ----- ###
        self.dockType_value = IntVar(value=1)
        self.blind_dock = Radiobutton(self.f4, text="Blind", bg="#999999", font="Roman 10", variable=self.dockType_value, value=1)
        self.targeted_dock = Radiobutton(self.f4, text="Targeted",  bg="#999999", font="Roman 10", variable=self.dockType_value, value=2, command=self.dummy)
        ...
        self.vina_dock = Radiobutton(self.f4, text="Vina", bg="#999999", font="Roman 10", variable=self.dockMethod_value, value=1)
        self.autodock_dock = Radiobutton(self.f4, text="Autodock",  bg="#999999", font="Roman 10", variable=self.dockMethod_value, value=2, command=self.dummy)
        ...
        # Lipinki - label
        self.lipin_label = Label(self.f5, text="Lipinski's Rule: ", font="Roman 10 bold")
        self.lipin_label.grid(row=1, sticky=W, pady=1, ipadx=5)
        # Lipinski's radio buttons
        self.lipin_value = IntVar(value=1)
        self.lipin_no = Radiobutton(self.f5, text="No",  bg="#999999", font="Roman 10", variable=self.lipin_value, value=1, command=self.apply_lipinRules)
        self.lipin_default = Radiobutton(self.f5, text="Default",  bg="#999999", font="Roman 10", variable=self.lipin_value, value=2, command=self.apply_lipinRules)
        self.lipin_custom = Radiobutton(self.f5, text="Custom",  bg="#999999", font="Roman 10", variable=self.lipin_value, value=3, command=self.apply_lipinRules)
        ...
        self.run_button = Button(self.f7, text="RUN", fg="green", font="Roman 11 bold", borderwidth=2, command=self.run)
        self.exit_button = Button(self.f7, text="EXIT", fg="red", font="Roman 11", command=self.exit)
        self.clear_button = Button(self.f7, text="CLEAR", fg="blue", font="Roman 11", command=self.clear_form)
    ...
    def FilterModule(self):
        ...
        if (answer):
            ...
            if (conf):
                ...
                self.spatialWindow.geometry("500x615") # width x length
    ...
    def run(self):
        ...
        #     ##......................................##           
            ...
            print("Elapsed Time for running", end_time - start_time, "seconds")
                #  ----------------------------------
            ...
            if (self.dockMethod_value.get() == 2):
                ...
                end_time = time.perf_counter ()
                print("Elapsed Time for running Docking AD4 (VSpipe-GUI)", end_time - start_time, "seconds")
...
class RecepPrepModule:
    def __init__(self, master):
        ...
        self.f1_title = Label(self.f1, text="Receptor Preparation", font="Roman 12 bold", fg="#660099")
        self.f1_title.pack(padx=90, pady=4)
        ...
        self.f2_pdbID = Label(self.f2, text="PDB ID: ", font="Roman 10 bold")
        self.f2_OR = Label(self.f2, text="OR", font="Roman 12 bold")
        self.f2_recep = Label(self.f2, text="Receptor: ", font="Roman 10 bold")
        self.f2_pdbID.grid(row=1, sticky=W, pady=5)
        ...
        self.pdbID_button.grid(row=1, column=3, padx=5, pady=5)
        ...
        self.radio_default = Radiobutton(self.f3, text="Keep the file by default", font="Roman 10", variable=self.radio_value, value=1, command=self.keep_metalIon)
        # myTip = Hovertip(self.radio_default,'Do nothing')
        self.radio_firstChain = Radiobutton(self.f3, text="Extract first chain and No metal ion", font="Roman 10", variable=self.radio_value, value=2, command=self.keep_metalIon)
        # myTip = Hovertip(self.radio_firstChain,'Remove water, ligand(s) and metal ion(s)')
        self.radio_metalIon = Radiobutton(self.f3, text="Extract first chain and keep the metal ion", font="Roman 10", variable=self.radio_value, value=3, command=self.keep_metalIon)
        ...
        self.f4_metal_ion = Label(self.f4, text="Specify Metal Ion: ", font="Roman 10")
        self.f4_metal_charge = Label(self.f4, text="Specify Metal Charge: ", font="Roman 10")
        self.f4_metal_ion.grid(row=1, sticky=W, pady=5)
        ...
        ### -----   Buttons for running the script, clearing and exiting the program ----- ###
        self.run_button = Button(self.f5, text="RUN", fg="green", font="Roman 10 bold", borderwidth=2, command=self.run)
        # myTip = Hovertip(self.run_button,'To generate PDBQT')
        self.exit_button = Button(self.f5, text="EXIT", fg="red", font="Roman 10", command=self.terminate)
        self.run_button.grid(row=3, column=6, padx=8)
        self.exit_button.grid(row=3, column=8, padx=8)
...
class LigandPrepModule:
    def __init__(self, master):
        ...
        # Frame Title
        self.f1_title = Label(self.f1, text="Compounds Library Preparation", font="Roman 12 bold", fg="#660099")
        self.f1_title.grid(row=1, column=3, columnspan=2, padx=55)
        ...
        self.tab1_label = Label(self.tab1, text="Please select following minimized compounds library:", font="Roman 10 bold")
        ...
        self.tab2_label = Label(self.tab2, text="Conversion and Minimization of file in sdf/mol2 format", font="Roman 10 bold")
        ...
        self.min_compLib_entry.grid(row=2, padx=100, pady=7)
...
class FiltrationModule:
    def __init__(self, master):
        ...
        self.f1_title.grid(row=1, column=5, sticky=W, padx=85)
        ...
        ### -----   Labels for Inputing file ----- ###
        self.vsResults_label = Label(self.f2, text="VS Results Directory: ", font="Roman 10 bold")
        ...
        ### -----   Labels for Inputing file ----- ###
        self.parmOrder_label = Label(self.f3, text="Sort the results by:  ", font="Roman 10 bold")
        ...
        # Yes/No Filter
        self.filter_label = Label(self.f3, text="Apply Filter:  ", font="Roman 10 bold")
        self.filter_label.grid(row=2, sticky=W, pady=20, ipadx=30)

        # Yes/No filter radio buttons
        self.filter_value = IntVar(value=1)
        self.filter_no = Radiobutton(self.f3, text="No",  bg="#999999", font="Roman 10", variable=self.filter_value, value=1, command=self.filtraton_option)
        self.filter_yes = Radiobutton(self.f3, text="Yes",  bg="#999999", font="Roman 10", variable=self.filter_value, value=2, command=self.filtraton_option)
        ...
        self.filter_1 = Radiobutton(self.f4, text="Filter 1",  bg="#999999", font="Roman 10", variable=self.choice_value, value=1, command=self.filter_choice)
        self.filter_2 = Radiobutton(self.f4, text="Filter 2",  bg="#999999", font="Roman 10", variable=self.choice_value, value=2, command=self.filter_choice)
        self.filter_3 = Radiobutton(self.f4, text="Filter 3",  bg="#999999", font="Roman 10", variable=self.choice_value, value=3, command=self.filter_choice)
        ...
        self.filter_1_label = Label(self.f4, text="Greater than:  ", font="Roman 10", bg="#999999")
        ...
        self.filter_2_label = Label(self.f4, text="Less than:  ", font="Roman 10", bg="#999999")
        ...
        self.filter_3_min = Label(self.f4, text="Range - Min:  ", font="Roman 10", bg="#999999")
        self.filter_3_max = Label(self.f4, text="Range - Max:  ", font="Roman 10", bg="#999999")
        ...
        ### -----   Buttons for running the script, clearing and exiting the program ----- ###
        self.run_button = Button(self.f5, text="RUN", fg="green", font="Roman 11 bold", borderwidth=2, command=self.run)
        self.exit_button = Button(self.f5, text="EXIT", fg="red", font="Roman 11", command=self.terminate)
        self.clear_button = Button(self.f5, text="CLEAR", fg="blue", font="Roman 11", command=self.dummy)
        self.run_button.grid(row=3, column=6, padx=8)
        self.exit_button.grid(row=3, column=8, padx=8)
        self.clear_button.grid(row=3, column=4, padx=8)
